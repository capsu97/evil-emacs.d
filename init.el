...
(defvar my-packages '(starter-kit starter-kit-lisp starter-kit-bindings starter-kit-eshell clojure-mode ace-jump-mode starter-kit-js paredit nrepl nrepl-ritz markdown-mode evil ac-nrepl color-theme
