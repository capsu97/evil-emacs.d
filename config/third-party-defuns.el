...
(defun ot/sp-previous-toplevel-defun ()
  "Go to previous toplevel defun"
  (interactive)
  (beginning-of-defun))

(defun ot/sp-next-toplevel-defun ()
  "Go to next toplevel defun"
  (interactive)
  (beginning-of-defun -1))

(defun ot/sp-duplicate-after-point
    ()
...
(defun ot/evil-paredit-comment-dwim ()
  (interactive)
  (progn
