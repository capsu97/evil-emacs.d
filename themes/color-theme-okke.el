...
(defun color-theme-okke ()
  ...
  ;; - green :      "#6ac214"
  ;; - orange/red : "tomato"
  ;; - background : "#2e3434" , #272822, #222222, "#272822"
  ;; - foreground : "#eeeeec"
  ;; - comment : "#888a85" (font-lock-comment-face)
  ;; - function name : "#729fcf" :bold t (font-lock-keyword-face)
  ;; - strings : "#ad7fa8" :italic t (font-lock-string-face)
  ;; - region background : "dark slate blue"
  ;; - highlight : "brown4" :foreground nil
  ;; - function : "#edd400" :bold t (font-lock-function-name-face)
  ;; - type : "#8ae234" :bold t (font-lock-type-face)
  ...
  (color-theme-install
   '(color-theme-okke
     ...
     (mode-line ((t (:foreground "#888a85" :background "#222222" :box (:line-width 1 :color nil)))))
     (mode-line-inactive ((t (:foreground "#888a85" :background "#555753"))))
     (mode-line-buffer-id ((t (:foreground "orange" :background nil :box (:line-width 1 :color "#888a85")))))
     ...
     (font-lock-comment-face ((t (:foreground "#716B59"))))
     (font-lock-constant-face ((t (:foreground "#8ae234"))))
     (font-lock-doc-face ((t (:foreground "#888a85"))))
     (font-lock-keyword-face ((t (:foreground "#55D7EF"))))
...
(provide 'color-theme-okke)

;;; color-theme-okke.el ends here
